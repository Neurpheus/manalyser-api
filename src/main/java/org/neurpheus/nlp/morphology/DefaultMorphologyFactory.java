...
public class DefaultMorphologyFactory implements MorphologyFactory {
     ...
     */
    private MorphologicalComponent findComponent(
            final Map componentsMap, final Locale loc,
            final double qualityImportance, final double speedImportance,
     ...
     */
    private Map createBestComponentsMap(
            final Map components,
            final double qualityImportance,
            final double speedImportance) {
        Map result = new HashMap();
        for (final Iterator it = components.keySet().iterator(); it.hasNext();) {
            Locale loc = (Locale) it.next();
            MorphologicalComponent component = findComponent(
                    components, loc, qualityImportance, speedImportance, null, null);
            if (component != null) {
     ...
     */
    private static List lookupForImplementations(
            final Class clazz,
            final ClassLoader loader,
            final String[] defaultImplementations,
            final boolean onlyFirst,
            final boolean returnInstances) throws ClassNotFoundException {
        if (clazz == null) {
        ...
        // check if input class can be used as a result
        ...
        if (res.size() == 0) {
            throw new ClassNotFoundException(
                    "Cannot find any implemnetation of class " + interfaceName);
        }
        return res;
    }
     ...
     */
    public Stemmer getStemmer(final Locale locale, final String propertyName, final Object propertyValue)
    ...
    public Stemmer getStemmer(
        ...
        MorphologicalComponent component =
                findComponent(stemmers, locale, qualityImportance, speedImportance, null, null);
        if (component == null) {
            throw new MorphologyException("Cannot find stemmer for locales : " + locale.toString());
        } else {
            return (Stemmer) component;
    ...
    public Lemmatizer getLemmatizer(
        ...
        MorphologicalComponent component =
                findComponent(lemmatizers, locale, 1, 1, propertyName, propertyValue);
        if (component == null) {
    ...
    public Lemmatizer getLemmatizer(
        ...
        MorphologicalComponent component =
                findComponent(lemmatizers, locale, qualityImportance, speedImportance, null, null);
        if (component == null) {
            throw new MorphologyException("Cannot find lemmatizer for locales : " + locale.toString());
        } else {
            return (Lemmatizer) component;
     ...
     */
    public MorphologicalAnalyser getMorphologicalAnalyser(
            final Locale locale, final String propertyName, final Object propertyValue)
            throws MorphologyException {
        if (locale == null) {
            throw new IllegalArgumentException("The 'loc' argument cannot be null.");
        }
        ...
        MorphologicalComponent component =
                findComponent(analysiers, locale, 1, 1, propertyName, propertyValue);
        if (component == null) {
            throw new MorphologyException(
                    "Cannot find morphological analyser for locales : " + locale.toString());
        } else {
     ...
     * if there is no matching morphological analyser.
     */
    public MorphologicalAnalyser getMostAccurateMorphologicalAnalyser(final Locale locale)
            throws MorphologyException {
        if (locale == null) {
            throw new IllegalArgumentException("The 'loc' argument cannot be null.");
        }
     ...
     * if there is no matching morphological analyser.
     */
    public MorphologicalAnalyser getFastestMorphologicalAnalyser(final Locale locale)
            throws MorphologyException {
        if (locale == null) {
            throw new IllegalArgumentException("The 'loc' argument cannot be null.");
        }
    ...
    public MorphologicalAnalyser getMorphologicalAnalyser(
        ...
        MorphologicalComponent component =
                findComponent(analysiers, locale, qualityImportance, speedImportance, null, null);
        if (component == null) {
            throw new MorphologyException(
                    "Cannot find morphological analyser for locales : " + locale.toString());
        } else {
     ...
     */
    public WordFormGenerator getGenerator(
            final Locale locale,
            final String propertyName,
            final Object propertyValue)
            throws MorphologyException {
        ...
        MorphologicalComponent component =
                findComponent(generators, locale, 1, 1, propertyName, propertyValue);
        if (component == null) {
    ...
    public WordFormGenerator getGenerator(
        ...
        MorphologicalComponent component =
                findComponent(generators, locale, qualityImportance, speedImportance, null, null);
        if (component == null) {
            throw new MorphologyException("Cannot find generator for locales : " + locale.toString());
        } else {
            return (WordFormGenerator) component;
