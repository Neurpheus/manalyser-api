/**
 *	This generated bean class Description
 *	matches the schema element 'description'.
...
public class Description {
	 ...
	 * Deep copy
	 */
	public Description(org.neurpheus.nlp.morphology.tagset.xml.Description source) {
		_Lang = source._Lang;
	...
	public void changePropertyByName(String name, Object value) {
		...
		if (name == "lang")
			...
			throw new IllegalArgumentException(name+" is not a valid property name for Description");
	}
	...
	public boolean equals(Object o) {
		if (o == this)
			return true;
		if (!(o instanceof org.neurpheus.nlp.morphology.tagset.xml.Description))
			return false;
		org.neurpheus.nlp.morphology.tagset.xml.Description inst = (org.neurpheus.nlp.morphology.tagset.xml.Description) o;
