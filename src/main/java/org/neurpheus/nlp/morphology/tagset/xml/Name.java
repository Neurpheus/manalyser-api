/**
 *	This generated bean class Name
 *	matches the schema element 'name'.
...
public class Name {
	 ...
	 * Deep copy
	 */
	public Name(org.neurpheus.nlp.morphology.tagset.xml.Name source) {
		_Lang = source._Lang;
	...
	public void changePropertyByName(String name, Object value) {
		...
		if (name == "lang")
			...
			throw new IllegalArgumentException(name+" is not a valid property name for Name");
	}
	...
	public boolean equals(Object o) {
		if (o == this)
			return true;
		if (!(o instanceof org.neurpheus.nlp.morphology.tagset.xml.Name))
			return false;
		org.neurpheus.nlp.morphology.tagset.xml.Name inst = (org.neurpheus.nlp.morphology.tagset.xml.Name) o;
